...
KEYWORD_COMPONENTS = ["forum", "quiz", "grade", "theme", "general"]
...
_COMPONENT_INDEX = {name: index for index, name in enumerate(KEYWORD_COMPONENTS)}


def assign_keyword_component(title: str) -> int:
...
def keyword_component_name(component_id: int) -> str:
    return KEYWORD_COMPONENTS[component_id]
