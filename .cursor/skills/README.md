# student-dkt Cursor Skills

DKT (Deep Knowledge Tracing) skills for this repo, split by layer:

| Skill | Path | Scope |
|-------|------|-------|
| **Index** | [dkt-onnx-showcase](dkt-onnx-showcase/SKILL.md) | Overview + pipeline checklist |
| **Python** | [dkt-python](dkt-python/SKILL.md) | Model, encoding, training, synthetic data |
