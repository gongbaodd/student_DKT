...
from electricity_dkt_generator import SKILLS, populate_data

DEFAULT_OUTPUT = Path("electricity_web/public/dkt.onnx")
DEFAULT_METADATA = Path("electricity_web/public/model-metadata.json")
OPSET_VERSION = 17
HIDDEN_DIM = 50
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train electricity DKT and export to ONNX."
    )
